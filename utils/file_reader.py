...
if __name__ == '__main__':
    #本机的配置文件地址，作为测试读取类之用，Attention! 路径中的分隔符是'/'
    y = 'C:/eclipse/workspace/salesforce_python_test/configurations/config.yml'
    reader = YamlReader(y)
    print(reader.data)

    e = 'C:/eclipse/workspace/salesforce_python_test/data/baidu.xlsx'
